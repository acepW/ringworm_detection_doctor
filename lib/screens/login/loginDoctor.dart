...
import 'package:ringworm_detection_doctor/constraints.dart';
...
class LoginScreensDoctor extends StatefulWidget {
  const LoginScreensDoctor({super.key});
  static const String routeName = '/loginDoctor';

  @override
  State<LoginScreensDoctor> createState() => _LoginScreensDoctorState();
}

class _LoginScreensDoctorState extends State<LoginScreensDoctor> {
  ...
  Future<void> _submitFormOnLogin() async {
    ...
    try {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, PageRoutes.Validasi, (route) => false);
